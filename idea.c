...
struct array_char * alloc_array_char(const char *s);
...
main(int argc, char **argv)
{
    ...
    struct array_char line1 = {10, 10, array_data_line1};
    ...
    /* Heap */
    struct array_char *line2 = NULL;
    line2 = alloc_array_char("hello2");
...
struct array_char *
alloc_array_char(const char *s)
{
    size_t slen = strlen(s);
    struct array_char *r =
        alloc_array(slen, slen * 2, s, slen + 1, sizeof(char));
    return r;
}
